...
export const DockIcon = ({
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
      className={cn(
        "flex aspect-square cursor-pointer items-center justify-center rounded-full transition-colors hover:bg-neutral-800 border border-transparent hover:border-neutral-700",
        className,
      )}
      {...props}
    >
